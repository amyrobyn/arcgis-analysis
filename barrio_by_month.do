...
drop _merge
merge 1:1 monthyear using "C:\Users\Amy\Google Drive\Kent\james\dissertation\chkv and dengue\arcgis analysis\gwr models\temperature_data_raw\temp_anomoly_2014-2016.dta"
drop _merge
merge 1:1 monthyear using "C:\Users\Amy\Google Drive\avg_rain\rain_months.dta"
reshape long
...
*/
twoway (line Avg_rain monthyear, sort jitter(0 7)) (scatter countzikabarrio monthyear, sort jitter(relativesize))  (scatter  countchikvbarrio monthyear, jitter(relativesize))  (scatter  countdenguebarrio monthyear, jitter(relativesize))  (line temp_anom_median_c monthyear, jitter(relativesize))
