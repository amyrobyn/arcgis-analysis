...
restore
preserve
collapse (mean) POINT_X POINT_Y Avg_rain temp_anom_median_c estrato_mon3210 services_coverage_index_sum empty_ratio total_pop educ_ratio arean3210 sabe_leer_y_escribir_ratio maletofemale alguna_limitacin_ratio  tasa_assist_index_sum services_index_sum indigena rom raizal  negro__a___mulato__afro ninguno_de_los_anteriores dist_barrio_canal_m logtemp_anom_median_c logAvg_rain logtotal_pop logarean3210 logestrato_mon3210 logindigena logrom lograizal lognegro__a___mulato__afrocolombian logninguno_de_los_anteriores logasistencia_educativa_ratio logalguna_limitacin_ratio logsabe_leer_y_escribir_ratio logservices_index_sum logservices_coverage_index_sum logtasa_assistenciaesc_index_sum logempty_ratio logmaletofemale, by(codigo_barrio)
...
*selected models
bysort countdenguedtabarrio countchikdtabarrio countzikadtabarrio: sum Avg_rain temp_anom_median_c total_pop arean3210 estrato_mon3210 educ_ratio sabe_leer_y_escribir_ratio services_coverage_index_sum empty_ratio maletofemale logtemp_anom_median_c logAvg_rain logtotal_pop logarean3210 logestrato_mon3210 logindigena logrom lograizal lognegro__a___mulato__afrocolombian logninguno_de_los_anteriores logasistencia_educativa_ratio logalguna_limitacin_ratio logsabe_leer_y_escribir_ratio logservices_index_sum logservices_coverage_index_sum logtasa_assistenciaesc_index_sum logempty_ratio logmaletofemale
